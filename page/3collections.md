...
* [CSS Generators -CSSREFLEX](https://www.cssreflex.com/css-generators/)
...
* [Unix 时间戳 Unix timestamp](https://tool.chinaz.com/Tools/unixtime.aspx)

- [在线正则表达式匹配](https://regex101.com/)
    - 这个功能更强大一点，能清楚的区分出贪婪和懒惰正则。
- [https://regexr.com/](http://regexr.com/)
...
* [JavaScript 标准参考教程（alpha） -阮一峰](https://javascript.ruanyifeng.com/)

* [JavaScript Promise迷你书 -azu](https://liubin.org/promises-book/)
...
- [YOU MIGHT NOT NEED JQUERY PLUGINS](https://youmightnotneedjqueryplugins.com/)

* [JavaScript 秘密花园](https://bonsaiden.github.io/JavaScript-Garden/zh/)

* [JavaScript 设计模式 系列 AlloyTeam](https://www.alloyteam.com/2012/10/common-javascript-design-patterns/)
...
* [Webpack傻瓜式指南（一） -前端外刊评论 知乎专栏](https://zhuanlan.zhihu.com/FrontendMagazine/20367175)

* [Webpack傻瓜指南（二）开发和部署技巧 -前端外刊评论 知乎专栏](https://zhuanlan.zhihu.com/FrontendMagazine/20397902)
...
* [Webpack，101入门体验 -Yika](https://www.html-js.com/article/3009)
...
* [Vue.js 和 Webpack（一） -Randy Lu](https://djyde.github.io/2015/08/29/vuejs-and-webpack-1/)
* [Vue.js 和 Webpack（二） -Randy Lu](https://djyde.github.io/2015/08/30/vuejs-and-webpack-2/)
* [Vue.js 和 Webpack（三） -Randy Lu](https://djyde.github.io/2015/08/31/vuejs-and-webpack-3/)
...
* [深入理解 React -Thinking in React 中文版](https://reactjs.cn/react/docs/thinking-in-react.html)
...
* [后端程序员的 JavaScript 之旅 - 模块化（一）](https://lishaopeng.com/2016/02/05/js-module/)
* [后端程序员的 JavaScript 之旅 - 模块化（二）](https://lishaopeng.com/2016/02/11/js-module2/)
* [后端程序员的 JavaScript 之旅 - 模块化（三）](https://lishaopeng.com/2016/02/19/js-module3/)

* [CommonJS 规范 -来自 阮一峰 JavaScript 标准参考教程(alpha)](https://javascript.ruanyifeng.com/nodejs/module.html)

## other articles

- [<head> Cheat Sheet](https://gethead.info/)
...
* [Gitbook 的使用和常用插件 -赵达](https://zhaoda.net/2015/11/09/gitbook-plugins/)
* [gitbook-plugin-expandable-chapters](https://plugins.gitbook.com/plugin/expandable-chapters)

    折叠左侧目录章节。

    <!-- ![](https://ww4.sinaimg.cn/large/7011d6cfjw1f08kmplbj1j20gn05l0tk.jpg) -->
...
* [Chrome扩展及应用开发 -图灵电子书](https://www.ituring.com.cn/minibook/950)
...
- [COLORFUL xiaoa](https://www.xiaoa.name/)

* [进击的马斯特 https://pinkyjie.com/](http://pinkyjie.com/)
...
* [小胡子哥 https://www.barretlee.com/](http://www.barretlee.com/)

    李靖，阿里巴巴。

* [Xcat Liu https://blog.xcatliu.com/](http://blog.xcatliu.com/)

    Microsoft Software Engineer II, Meituan Senior Front-End Engineer

* [极限前端 https://ouvens.github.io/](http://ouvens.github.io/)

    Ouvenzhang, 前端工程师，对前端领域的技术知识具有较高的职业能力和探究精神。对响应式页面设计、工程构建组件化、mv*设计实现、前端优化、ES6开发体系等有深入的研究与项目实践。来自腾讯科技。

* [凳子_Joinery 邓智容  https://www.dengzhr.com/](http://www.dengzhr.com/)

* [赵达的个人网站 腾讯高级前端开发工程师](https://zhaoda.net/)

* [Randy](https://djyde.github.io/)

    95年出生的全栈。卢涛南，英文名 Randy，用 djyde 这个ID混迹于网络。

* [JS前端开发群月报 -豪情等人维护](https://www.kancloud.cn/jsfront/month/82796)
